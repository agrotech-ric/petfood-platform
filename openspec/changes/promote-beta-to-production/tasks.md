...
- [ ] 5.4 Run secret scanning and confirm that environment files, active credentials, database dumps, media archives, and generated build outputs are absent from the promotion diff and every accepted legacy-history increment.
