...
public class ReferenceController {
    ...
    public List<dev.pet.pets.dto.HealthConditionItem> healthConditions() {
        return healthConditionRepository.findAll().stream()
            .map(h -> new dev.pet.pets.dto.HealthConditionItem(h.getId(), h.getCode(), h.getNameRu()))
            .sorted(java.util.Comparator.comparing(dev.pet.pets.dto.HealthConditionItem::getNameRu))
            .toList();
    }
